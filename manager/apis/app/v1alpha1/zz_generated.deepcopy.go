...
func (in *BlueprintModule) DeepCopyInto(out *BlueprintModule) {
	*out = *in
	...
	if in.SourceAssets != nil {
		in, out := &in.SourceAssets, &out.SourceAssets
		*out = make([]AssetConfiguration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SinkAssets != nil {
		in, out := &in.SinkAssets, &out.SinkAssets
		*out = make([]AssetConfiguration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *BlueprintSpec) DeepCopyInto(out *BlueprintSpec) {
	*out = *in
	if in.Modules != nil {
		...
		*out = make([]BlueprintModule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
